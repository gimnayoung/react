        ...
        <div>
          <form>
            <div className="detailbutton">
              <button value={0} type="button" onClick={()=>{setTap(0);}}>
                <label for="menu-1"> 상품정보
                  <input type="radio" id="menu-1" name="tap" checked/>
                </label>
              </button>
            </div>
            <div className="detailbutton">
              <button value={1} type="button" onClick={()=>{setTap(1);}}>
                <label  for="menu-2"> 리뷰
            ...
            <div className="detailbutton">
              <button value={2} type="button" onClick={()=>{setTap(2);}}>
                <label  for="menu-3">Q&A
                  <input type="radio" id="menu-3" name="tap"/>
                </label>  
              </button>
            </div>
            <div className="detailbutton"> 
              <button value={3} type="button" onClick={()=>{setTap(3);}}>
                <label  for="menu-4">주문정보
